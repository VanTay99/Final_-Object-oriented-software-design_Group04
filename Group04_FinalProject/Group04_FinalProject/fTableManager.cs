...
using static Group04_FinalProject.fAccountPropfile;
...
namespace Group04_FinalProject
{
    public partial class fTableManager : Form
    {
        ...
        void ShowBill(int id)
        {
            ...
            lsvBill.Items.Clear();
            List<Group04_FinalProject.DTO.Menu> listBillInfo = MenuDAO.Instance.GetListMenuByTable(id);
            float totalPrice = 0;
            foreach (Group04_FinalProject.DTO.Menu item in listBillInfo)
            {
        ...
        {
            fAccountPropfile f = new fAccountPropfile(LoginAccount);
